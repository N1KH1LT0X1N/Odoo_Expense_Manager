...
import { DollarSign, Lock, Mail, User, Building2, ArrowLeft, CheckCircle2 } from "lucide-react";
        ...
        <Card className="border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-2xl">
          <CardHeader className="space-y-4">
            ...
            <CardDescription className="text-center text-gray-600 dark:text-gray-400 text-base">
              Start managing expenses smarter today
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link href="/login" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium hover:underline">
                  Sign in instead
                </Link>
              </div>
            </form>
